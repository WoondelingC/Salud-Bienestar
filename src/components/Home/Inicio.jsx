...
export const Inicio = () => {
    return (
        <div className="container-fluid">
            ...
            <header>
                <img src={imgHeader} className="img-fluid" alt="Imagenes-iconos" />
            </header>

            <div classNameName="container__Agendar-cita">
                <div classNameName="container__Agendar-cita--titleImg">
            ...
            <div classNameName="container__categorias--tips">
            ...
            <div classNameName="container__categorias--servicios">
                <h1>Servicios</h1>
            ...
            <div classNameName="container__contacto">
                <h1>Contactanos</h1>
                <div classNameName="container__contacto-p">
